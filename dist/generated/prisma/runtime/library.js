...
`), o = o.replace(/\\r/g, "\r")), r[i] = o;
  ...
  function ks(e) {
    ...
    if (e && e.path && e.path.length > 0) {
      if (Array.isArray(e.path)) for (let t of e.path) Ni.existsSync(t) && (r = t.endsWith(".vault") ? t : `${t}.vault`);else r = e.path.endsWith(".vault") ? e.path : `${e.path}.vault`;
...
function tc(e) {
  return hr(e).with({
    ...
    archFromUname: r
  }) => (ee('Trying platform-specific paths for "debian" (and "ubuntu")'), [`/usr/lib/${r}-linux-gnu`, `/lib/${r}-linux-gnu`])).with({
    familyDistro: "rhel"
...
var zt = globalThis.window?.document !== void 0,
  ...
  Sg = Zr === "macOS" || globalThis.navigator?.platform === "MacIntel" || globalThis.navigator?.userAgent?.includes(" Mac ") === !0 || globalThis.process?.platform === "darwin",
  Rg = Zr === "Windows" || globalThis.navigator?.platform === "Win32" || globalThis.process?.platform === "win32",
  Cg = Zr === "Linux" || globalThis.navigator?.platform?.startsWith("Linux") === !0 || globalThis.navigator?.userAgent?.includes(" Linux ") === !0 || globalThis.process?.platform === "linux",
  Ag = Zr === "iOS" || globalThis.navigator?.platform === "MacIntel" && globalThis.navigator?.maxTouchPoints > 1 || /iPad|iPhone|iPod/.test(globalThis.navigator?.platform),
  Ig = Zr === "Android" || globalThis.navigator?.platform === "Android" || globalThis.navigator?.userAgent?.includes(" Android ") === !0 || globalThis.process?.platform === "android";
var I = "\x1B[",
  et = "\x1B]",
  yr = "\x07",
  Xr = ";",
...
m.toFraction = function (e) {
  var r,
    ...
    g = f.constructor;
  if (!h) return new g(f);
  if (u = t = new g(1), n = l = new g(0), r = new g(n), o = r.e = Qs(h) - f.e - 1, s = o % b, r.d[0] = U(10, s < 0 ? b + s : s), e == null) e = o > 0 ? r : u;else {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (_[p] > (K[p] || 0) && c--, o == null ? (ae = o = jt.precision, s = jt.rounding) : a ? ae = o + (n.e - i.e) + 1 : ae = o, ae < 0) R.push(1), h = !0;else {
      if (ae = ae / f + 2 | 0, p = 0, H == 1) {
        ...
        do d = 0, u = r(_, E, H, D), u < 0 ? (me = E[0], H != D && (me = me * l + (E[1] || 0)), d = me / Ae | 0, d > 1 ? (d >= l && (d = l - 1), g = e(_, d, l), S = g.length, D = E.length, u = r(g, E, S, D), u == 1 && (d--, t(g, H < S ? fr : _, S, l))) : (d == 0 && (u = d = 1), g = _.slice()), S = g.length, S < D && g.unshift(0), t(E, g, D, l), u == -1 && (D = E.length, u = r(_, E, H, D), u < 1 && (d++, t(E, H < D ? fr : _, D, l))), D = E.length) : u === 0 && (d++, E = [0]), R[p++] = d, u && E[0] ? E[D++] = K[V] || 0 : (E = [K[V]], D = 1); while ((V++ < te || E[0] !== void 0) && ae--);
        h = E[0] !== void 0;
      }
      R[0] || R.shift();
    }
...
function y(e, r, t, n) {
  ...
  e: if (r != null) {
    ...
    if (o = r - i, o < 0) o += b, s = r, c = p[d = 0], l = c / U(10, i - s - 1) % 10 | 0;else if (d = Math.ceil((o + 1) / b), a = p.length, d >= a) {
      if (n) {
        for (; a++ <= d;) p.push(0);
...
function Ui(e, r) {
  ...
  for (n = Math.log(U(2, p)) / Math.LN10 * 2 + 5 | 0, l += n, t = o = s = new d(1), d.precision = l;;) {
    if (o = y(o.times(e), l, 1), t = t.times(++c), a = s.plus(L(o, t, l, 1)), J(a.d).slice(0, l) === J(s.d).slice(0, l)) {
      ...
      if (r == null) {
        if (u < 3 && at(s.d, l - n, f, u)) d.precision = l += 10, t = o = a = new d(1), c = 0, u++;else return y(s, d.precision = h, f, w = !0);
...
function Je(e, r) {
  ...
  for (p = g, l = s = g = L(g.minus(1), g.plus(1), c, 1), d = y(g.times(g), c, 1), i = 3;;) {
    if (s = y(s.times(d), c, 1), u = l.plus(L(s, new P(i), c, 1)), J(u.d).slice(0, c) === J(l.d).slice(0, c)) if (l = l.times(2), o !== 0 && (l = l.plus(mn(P, c + 2, E).times(o + ""))), l = L(l, new P(f), c, 1), r == null) {
      if (at(l.d, c - h, R, a)) P.precision = c += h, u = s = g = L(p.minus(1), p.plus(1), c, 1), d = y(g.times(g), c, 1), i = a = 1;else return y(l, P.precision = E, R, w = !0);
...
function Tp(e, r) {
  ...
  if (bp.test(r)) t = 16, r = r.toLowerCase();else if (Ep.test(r)) t = 2;else if (wp.test(r)) t = 8;else throw Error(He + r);
...
function $p(e) {
  ...
  for (r = 0; r < o.length; r += 3) if (t = o[r], i && (this[t] = Vi[t]), (n = e[t]) !== void 0) if (X(n) === n && n >= o[r + 1] && n <= o[r + 2]) this[t] = n;else throw Error(He + t + ": " + n);
  if (t = "crypto", i && (this[t] = Vi[t]), (n = e[t]) !== void 0) if (n === !0 || n === !1 || n === 0 || n === 1) {
    if (n) {
      if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) this[t] = !0;else throw Error(Bs);
    } else this[t] = !1;
...
function Ys(e) {
  ...
  if (i.prototype = m, i.ROUND_UP = 0, i.ROUND_DOWN = 1, i.ROUND_CEIL = 2, i.ROUND_FLOOR = 3, i.ROUND_HALF_UP = 4, i.ROUND_HALF_DOWN = 5, i.ROUND_HALF_EVEN = 6, i.ROUND_HALF_CEIL = 7, i.ROUND_HALF_FLOOR = 8, i.EUCLID = 9, i.config = i.set = $p, i.clone = Ys, i.isDecimal = qs, i.abs = Rp, i.acos = Cp, i.acosh = Ap, i.add = Ip, i.asin = kp, i.asinh = Dp, i.atan = Op, i.atanh = _p, i.atan2 = Np, i.cbrt = Lp, i.ceil = Fp, i.clamp = Mp, i.cos = qp, i.cosh = jp, i.div = Vp, i.exp = Bp, i.floor = Up, i.hypot = Gp, i.ln = Qp, i.log = Wp, i.log10 = Hp, i.log2 = Jp, i.max = Kp, i.min = Yp, i.mod = zp, i.mul = Zp, i.pow = Xp, i.random = ed, i.round = rd, i.sign = td, i.sin = nd, i.sinh = id, i.sqrt = od, i.sub = sd, i.sum = ad, i.tan = ld, i.tanh = ud, i.trunc = cd, e === void 0 && (e = {}), e && e.defaults !== !0) for (n = ["precision", "rounding", "toExpNeg", "toExpPos", "maxE", "minE", "modulo", "crypto"], r = 0; r < n.length;) e.hasOwnProperty(t = n[r++]) || (e[t] = this[t]);
  return i.config(e), i;
}
function Vp(e, r) {
...
var Wa = e => Array.isArray(e) ? e : e.split("."),
  ...
  Ja = (e, r, t) => Wa(r).reduceRight((n, i, o, s) => Object.assign({}, oo(e, s.slice(0, o)), {
    [i]: n
  }), t);
function km(e, r) {
